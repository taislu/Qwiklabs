...
# a phone number field, and a role field. The phone number field contains U.S. phone numbers, and needs to be 
...
def transform_record(record):
  new_record = re.sub(r"________________", r"________", record)
  return new_record
